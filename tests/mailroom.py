    ...
    while answer: # Using a name variable to file the input, it will
        ...
        if name == "List":
            ...
            while answer:
                ...
                if name in donor: # If the name already exists, find the values in the list and replace them
                    ...
                    main_menu()
                    answer = False
                elif name not in donor: # If not in the list, then make new entry on new spots of the list
                    donor.append(name)
...
def donor_list(): # Shows a list of donors, just the name itself
...
def report(): #Goes through a loop and executes each print command with the appropriate names and spots
